...
class Wr {
  ...
  static fromObject(e, t = {}) {
    ...
    var w, p, v, T, w = (d ? (p = i, v = F(p.weekYear), t = A(p.weekNumber, 1, Y(p.weekYear)), T = A(p.weekday, 1, 7), v ? t ? !T && mr("weekday", p.weekday) : mr("week", p.week) : mr("weekYear", p.weekYear)) : a ? (w = i, T = F(w.year), p = A(w.ordinal, 1, R(w.year)), T ? !p && mr("ordinal", w.ordinal) : mr("year", w.year)) : Sr(i)) || br(i);
  ...
  static fromISO(e, t = {}) {
    var [r, n] = Qe(e, [vt, Ot], [Tt, Mt], [St, kt], [bt, Nt]);
